...
app.controller('mainController', ['$http','$routeParams', function ($http, $routeParams) {
	...
	$http({
		method: 'GET',
		url: 'https://rrf-api.herokuapp.com/klasses',
	...
	this.getCurrentUser = () => {
		$http({
			method: 'GET',
			url: 'https://rrf-api.herokuapp.com/users/currentuser',
			headers: {Authorization: 'Bearer ' + JSON.parse(localStorage.getItem('token'))}
		}).then((response) => {
	...
	this.login = (userPass) => {
		$http({
			method: 'POST',
			url: 'https://rrf-api.herokuapp.com/users/login',
	...
	this.register = (userPass) => {
		$http({
			method: 'POST',
			url: 'https://rrf-api.herokuapp.com/users',
			data: { user: { username: userPass.username, password: userPass.password }}
		}).then((response) => {
			console.log(response);
			this.login(userPass);
...
app.controller('groupsController', ['$http','$location','$routeParams', function ($http, $location ,$routeParams) {
	...
	$http({
		method:'GET',
		url: 'https://rrf-api.herokuapp.com/groups',
	}).then((response) => {
	...
	this.getRaids = () => {
		$http({
			method:'GET',
			url: 'https://rrf-api.herokuapp.com/raids'
		}).then((response) => {
	...
	this.createGroup = () => {
		...
		this.final_group = {
			...
			$http({
				...
				$http({
					method:'POST',
					url: 'https://rrf-api.herokuapp.com/ledgers',
					data: {
...
app.controller('groupController', ['$http','$routeParams', function ($http, $routeParams) {
	...
	this.getGroup = () => {
		$http({
			method:'GET',
			url: 'https://rrf-api.herokuapp.com/groups/' + $routeParams.id,
		}).then((response) => {
	...
	this.apply = () => {
		...
		$http({
			method:'POST',
			url: 'https://rrf-api.herokuapp.com/requests/',
	...
	this.getRequests = () => {
		$http({
			method:'GET',
			url: 'https://rrf-api.herokuapp.com/requests/' + this.group_id
		}).then((response) => {
	...
	this.accept = (id) => {
		$http({
			method:'GET',
			url: 'https://rrf-api.herokuapp.com/requests/accept/' + id
		}).then((response) => {
			console.log(response)
			this.getGroup()
			this.getRequests()
	...
	this.reject = (id) => {
		$http({
			method:'GET',
			url: 'https://rrf-api.herokuapp.com/requests/reject/' + id
		}).then((response) => {
			console.log(response)
			this.getGroup()
			this.getRequests()
...
app.controller('profileController', ['$http','$routeParams', function ($http, $routeParams) {
	...
	this.addChar = (user_id) => {
		...
		$http({
			method:'POST',
			url: 'https://rrf-api.herokuapp.com/characters',
			data: this.newChar
		}).then((response) => {
			console.log(response)
			this.newChar = {};
